...
namespace General
{
    public class Launcher : MonoBehaviour
    {
        ...
        private string VersionsFileDownloadURL { get { return JSONExtension.LoadEnv("FTP_HOST") + "/" + JSONExtension.LoadEnv("FTP_PATH") + "/patch/patches/versions.txt"; } }

        //[Tooltip("Your patches directory remote URL")]
        //public string PatchesDirectoryURL = "http://your/url/to/patches/directory/";
        private string PatchesDirectoryURL { get { return JSONExtension.LoadEnv("FTP_HOST") + "/" + JSONExtension.LoadEnv("FTP_PATH") + "/patch/patches/"; } }

        [Tooltip("Your game name! This string will be attached to app root path to launch your game when patching process will end!")]
        public string AppToLaunch = "App.exe";
        ...
        private string BuildsDirectoryURL { get { return JSONExtension.LoadEnv("FTP_HOST") + "/" + JSONExtension.LoadEnv("FTP_PATH") + "/patch/builds/"; } }
        ...
        public bool InstallInLocalPath = true;
        ...
        private string Username { get { return JSONExtension.LoadEnv("FTP_USERNAME"); } }

        //[Tooltip("Password for your requests")]
        //public string Password = "YourPasswordHere";
        private string Password { get { return JSONExtension.LoadEnv("FTP_PASSWORD"); } }
        ...
        {
            Debug.Log(VersionsFileDownloadURL);
            Debug.Log(PatchesDirectoryURL);
            Debug.Log(BuildsDirectoryURL);
            Debug.Log(Username);
            Debug.Log(Password);
        }
